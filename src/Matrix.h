...
public:
	...
	void set_value(matrix_size column, matrix_member value);

	const matrix_size get_column_count() const;
...
public:
	...
	void set_value(matrix_size row, matrix_size column, matrix_member value);
	void set_row(matrix_size row_index, CMatrixRow* row);

	const matrix_size get_column_count() const;
	const matrix_size get_row_count() const;
